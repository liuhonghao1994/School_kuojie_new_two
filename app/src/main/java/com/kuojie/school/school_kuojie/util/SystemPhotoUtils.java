...
//        boolOpenCarmer(context);
        ...
        ThemeConfig themeConfig = new ThemeConfig.Builder()
                .setTitleBarBgColor(context.getResources().getColor(R.color.colorPrimary))    //标题栏背景颜色
                ...
                .setFabNornalColor(context.getResources().getColor(R.color.colorPrimary))                       //设置Floating按钮Normal状态颜色
                .setFabPressedColor(Color.parseColor("#FF6759B1"))                     //设置Floating按钮Pressed状态颜色
                .setCheckNornalColor(Color.WHITE)                   //选择框未选中的颜色
                .setCheckSelectedColor(Color.BLACK)                 //选择框选中的颜色
                /*.setIconBack(R.drawable.backimg)                   //设置返回按钮icon
